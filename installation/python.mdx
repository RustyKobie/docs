---
title: 'Python'
description: 'How to install python on your own device.'
icon: 'python'
---

## Anaconda (recommended)

The easiest way to get started with python is to install anaconda:

https://www.anaconda.com/download/success

After the installation is complete you will have conda available in your anaconda powershell (on windows) and in your terminal on Mac OS.

if conda is not activated you can just type:
```
conda activate
```
...
Alternatively you can install Python using the Microsoft Store:
