---
title: 'Installing and setting up Cast'
...
Open the directory and check that the Cast directory is setup correctly. The following folders should be in the directory: 
```
Cast/
├── configs/
├── data/
